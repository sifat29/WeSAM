  ...
  <header>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                 <ul class="navbar-nav ml-auto">
                   ...
                   <li class="nav-item dropdown view">
                        ...
                        <a class="dropdown-item" href="sadia_anjum.html" target="_blank">SADIA ANJUM</a>
                        <a class="dropdown-item" href="fahim_hossain.html" target="_blank">FAHIM HOSSAIN</a>
                        <a class="dropdown-item" href="rahnuma_mahzabin.html" target="_blank">RAHNUMA MAHZABIN</a>
   ...
   <section id="s1">
       <div class="container-fluid">
        ...
        <div id="topline">
            <p>Hi, <?php echo $_SESSION['success'];?>!</p>
            <ul>
               </div>
   ...
   <section id="s3">
       <div class="container">
           <div class="row">
               <div class="col-lg-6">
                   <p class="p3"><b>About WESAM</b></p>
                   <img src="images/section3%20line%20-%20Copy.png" class="img1">
                   <p class="p4" style="font-family: font-family: Times New Roman, Times, serif; font-size: 120%;">It is a personal website about us</p>
                   <p class="p5" style="font-family: font-family: Times New Roman, Times, serif; font-size: 120%;">This website contains our personal information. In this website we have share our projects that we have done at different time in our graduation.</p>
                   <p class="p5" style="font-family: font-family: Times New Roman, Times, serif; font-size: 120%;">Anyone who wants customize project, who can contact with us. We are interested to do customize project for user. We are excited to help our users on their journey.</p>
               </div>
               <div class="col-lg-6">
                   <img src="images/book1.jpg" class="img-fluid foco">
               </div>
           </div>
       </div>
   </section>
